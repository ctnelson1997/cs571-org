...
export default function TimerForm(props) {
    ...
    const begin = (tm, rnd, tmDn) => {
        ...
        if (!rnd) {
            props.goOn(currDate, new Date(currDate.getTime() + mins * 60 * 1000));
        } else {
            let newDate;
            ...
            props.goOn(currDate, newDate);
        }
    }

    const handleSubmit = (e) => {
        e.preventDefault();
        begin(inpTime, doRound, timeDenom)
    }
                    ...
                    <div style={{ width: "100%" }}>
                        ...
                        <Form onSubmit={handleSubmit}>
                            ...
                            <div style={{ display: "inline-flex", marginTop: "0.25rem", float: "left" }}>
                                <Form.Check id="roundUp" checked={doRound} onChange={(e) => setDoRound(r => !r)}></Form.Check>
